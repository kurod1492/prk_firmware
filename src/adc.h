...
void c_adc_set_temp_sensor_enabled(mrb_vm *vm, mrb_value *v, int argc);
...
#define ADC_INIT() do { \
  ...
  mrbc_define_method(0, mrbc_class_object, "adc_set_temp_sensor_enabled",  c_adc_set_temp_sensor_enabled);  \
} while (0)